              ...
              <?php $no=1; foreach ($peminjaman as $key => $value){ ?> 
                ...
                <tr>
                    ...
                    <td class="p-3" style="align-items: center; text-align: center;">
                        <a href="<?=base_url('peminjamanadmin/delete/' .$value->id)?>" onclick="return confirm('Data yang dihapus tidak akan bisa dikembalikan, Yakin ingin menghapus?')" class="btn btn-warning btn-sm">Kembalikan</a>
                    </td>
                </tr>
                <?php } ?>
            </tbody>
