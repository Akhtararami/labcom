...
<div class="tabel p-5">
        ...
        <a href="<?=base_url('inventarisadmin')?>" class="btn btn-warning">Kembali</a>
        </div>
        </div>
      </div>
    </div>
