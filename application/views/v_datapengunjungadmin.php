<?php echo form_open('pengunjungadmin/data_pengunjung') ?>
...
<div class="kontrol">
        ...
        <div class="form-group">
            ...
            <input class="form-control" type="date" id="tanggal" placeholder="Nama Barang" name="tanggal" required>
        </div>
        <div class="form-group">
            <label for="siswa_ion">Siswa ION'S: (Pilih salah satu)</label>
            <div class="input-group">
                <select class="form-select" id="siswa_ion" name="siswa_ion" required style="width: 5000px;  height:50px; border: none; border-radius: 0.8rem;
            background: #fafafa;
            padding-top: 0.8rem;
          ...
          <div class="form-group">
            <div class="row">
                <div class="col-6">
                    ...
                    <input class="form-control" type="email" id="email" placeholder="example@gmail.com" name="email" required>
                </div>
                <div class="col-6">
                    <label for="nomor">No WA Aktif :</label>
                    <input class="form-control" type="int" id="nomor" placeholder="089XXXX" name="nomor" required>
                </div>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="input-group">
                <select class="form-select" id="keperluan" name="keperluan" required style="width: 5000px;  height:50px; border: #EAEAEA; border-radius: 0.8rem;
                    background: #fafafa;
                    padding-top: 0.8rem;
                    padding-bottom: 0.8rem;
                    padding-left: 1rem;
        ...
        <div class="form-group">
            ...
            <input class="form-control" type="text" id="no_loker" placeholder="Nomor loker" name="no_loker" required>
        </div>      
        <div class="form-group">
          <label for="siswa_ion">Pelaksaan Test</label>
          <div class="input-group">
                  <select class="form-select" id="keterangan" name="keterangan" required style="width: 5000px;  height:50px; border: none; border-radius: 0.8rem;
                    background: #fafafa;
                    padding-bottom: 0.8rem;
                    padding-left: 1rem;
                    padding-top : 0.8rem;
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" id="no_kuitansi" placeholder="Nomor kuitansi" name="no_kuitansi" required>
            </div>
      </div>
