              ...
              <?php $no=1; foreach ($returned as $key => $value){ ?> 
                ...
                <tr>
                    ...
                    <td class="p-3" style="align-items: center; text-align: center;">
                        <a href="<?=base_url('peminjamanadmin/hapus_data/' .$value->id)?>" onclick="return confirm('Pastikan bahwa anda sudah memenuhi pesan dibawah!')" class="btn btn-warning btn-sm">Kembalikan</a>
                    </td>
                </tr>
                <?php } ?>
            </tbody>
